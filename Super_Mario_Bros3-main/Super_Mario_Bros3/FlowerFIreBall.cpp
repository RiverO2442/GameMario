...
void CFlowerFireBall::Update(DWORD dt, vector<LPGAMEOBJECT>* coObjects)
{
...
void CFlowerFireBall::GetBoundingBox(float& l, float& t, float& r, float& b)
{
	l = x;
	t = y;
...
void CFlowerFireBall::SetState(int state)
{
